...
* Project: [**printf project**](https://github.com/leroysb/printf)
...
* Project: [**Monty project (Stacks, Queues - LIFO, FIFO)**](https://github.com/leroysb/monty)

## Linux and Unix system programming
* File I/O >> [0x15-file_io](./0x15-file_io)
* Project: [**Create a simple shell project**](https://github.com/leroysb/simple_shell)
